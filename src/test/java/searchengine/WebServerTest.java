...
class WebServerTest {
    ...
    // server.getHttpServer().getAddress().getPort());
    // assertEquals(
    // "[{\"url\": \"http://page1.com\", \"title\": \"title1\"}, {\"url\":
    // \"http://page2.com\", \"title\": \"title2\"}]",
    ...
    @Test
    void getHttpServerTest() {
        var serverTest = server.getHttpServer();
        assertNotEquals("", serverTest);
